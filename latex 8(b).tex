...
\section{Solution}
 ...
 Semi-Verical angle = $45^\circ$\\
 So 
 \begin{align}
 h &= l \sin 45 = \frac{l}{\sqrt{2}} \\
 r &= l\cos 45 = \frac{l}{\sqrt{2}}
 \end{align}
 So , equation (2.0.1) becomes 
 \begin{align}
 V &= \frac{1}{3} \pi {\frac{l}{\sqrt{2}}}^2 \frac{l}{\sqrt{2}}\\
 V &= \frac{\pi}{6\sqrt{2}} l^3
 \end{align}
 Differentiating it w.r.t $t$ will give us rate of change of volume\\
 \begin{align}
 \frac{dV}{dt} &= \frac{\pi}{6\sqrt{2}} 3l^2 \frac{dl}{dt}\\
 \frac{dV}{dt} &= \frac{\pi}{2\sqrt{2}} l^2 \frac{dl}{dt}\\
 \frac{dl}{dt} &= \frac{2\sqrt{2} dV}{\pi l^2 dt} 
 \end{align}
